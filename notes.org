...
- large stone tools
- made of flint
  + really sharp, we still use it for surgeries today
- flint hand axe
...
- *interaction/trade with Egyptians*
...
- calendar
**** Transportation
- people want to trade with Sumerians because they had a lot of wealth
***** Wheel
**** Army
- weapons
- armour
...
- predictable flooding, unlike the area the Sumerians were in
  ...
  + Nilometer
    ...
    - Pharaoh kept secret
    - this knowledge kept secret from commoners (farmers)
...
- preoccupied with afterlife
  + engineering schemes just produced gigantic tombs
...
**** Pyramids
food surplus funnelled into building pyramids
- large tombs
...
- Pharaohs pays farmers to work -> they don't overthrow the government because they're busy
...
1700BC
Nomadic people
- Captured Egypt, got rid of Pharaohs
- Egyptians eventually recaptured, and put Pharaohs back in charge, but
...
- scientific method, new technologies
...
4. Parmenides of Elea
   ...
   - part of stoic movement
     ...
     + there is no point of acting on anything because everything stays the same
   ...
   - sphere is a perfect form with no impurities
     ...
     + kind of like a gymnasium
       ...
       - lots of parties
         ...
         + orgies
       - only for men
         + believed women should not be involved in philosophical and scientific endeavours
...
7. Empedocles
   An empiricist
   + c. 492-432BC
   + believed that whatever you experience/discover in science can only be done through your senses, through empirical evidence
   + used an  approach like modern science
   + first volcanologist
...
9. Aristotle
   ...
   - thought Earth was at the centre of the universe
   - introduced physics
   ...
   - "father of biology"
     + dissected animals
     + vivisected (cut while still alive)
     + classified species
   - created a school:  Lyceum 335BC
     + still get drunk and have orgies like in Academy
...
- 11 contraptions
  ...
  6. coin operated vending machine
     - holy water
     - wine
     - different coins vended different things (e.g. more expensive wine)
  7. fire engine
  ...
  10. high pressure atomizer (spray)
      - perfume bottle
      - carburettor based on this (best car at the time, Mercedes)
...
- Roman Empire 44BC - 500AD (West), 1453AD (East)
  + ended when Constantinople was taken in 1453AD
...
- used Phalanx-Greek system initially
  ...
  + alexander was successful because he cut them in half which made it more manoeuvrable
  + Romans copied too
...
- before 107BC Only the wealthy were in army
  + usually your daddy is a General
  + you're in the army for only as long as the war lasts
  + gain fame, prestige, loot
  + when war happens, important government people are gone
...
- columns built in sections on a lathe
  + joined together with shaft though centre hole
- Octavian covered Rome with Marble, emperor
*** Building a building
...
- big building testifying prestige and strength of emperor
...
- main tunnel to deliver all the waste water, which then dumps into a river
...
- Christianity - 300AD new capital Constantinople
  ...
  + Constantine wanted to move away from Rome because it was filled with Pagan temples
  + made a new capital Constantinople
...
- concluded that basically everyone else is back in the stone age
  ...
  - build wall
  - emperor ordered destruction of ships
...
- Turks got cannons from Mongols who got it from Ancient China
  + used cannons to besiege Constantinople
  + broke walls
...
- they successfully recaptured Jerusalem
...
- Ptolemaic/Platonic cosmos part of Christian ideology
...
- realized that introduction of printing press and mass production of Bibles could make him wealthy
  ...
  + died in poverty
    ...
    - Fust comes with police and takes possession of everything he had, threw him out
...
- invented by Sumerians
  + water clocks wre used by Alexandrian doctors to measure pulse
- can measure time indoors and at night (water clock)
*** Candle Clock
- water freezes at night in medieval Europe
...
- designed to be an alarm clock
  ...
  + candle melts, and in time, nail will fall, make noise, and hopefully you wake up
- expensive
...
- c1327 Monk Richard of Wallingford
...
- Latitude was easy to tell (North-South)
  + declination
...
- could adapt to changing temperature, humidity, and still be accurate
...
- a Patek Phillipe watch is obsolete, still costs $11M
...
- 1903 Switzerland starts producing pocket watches
*** Swiss Watches
...
- 1903-1968 supplied 80% of watches
...
- independent inventor/inborn genius
...
- a bunch of small revolutions, i.e. *paradigm shifts*
  ...
  3. novelty/anomaly appears (something that could not be predicted)
     - cannot be explained by established science
...
- can publish your own ideas without being censored by the Church
...
- first mathematical model of universe with geocentrism and epicycles
...
- first major scientist who openly opposed Aristotelian logic
...
- Royal society invited him to present a demo
  ...
  - kills himself
**** facts
- first group of people to use experimental approach
...
- most famous scientists were alchemists
  - Robert Boyle: Sceptical Chymist
    - the book is basically an attack on alchemy (ironic)
    - today known as the father of chemistry lol
...
- methodology for establishing facts
...
- French academy was like Mouseion from ancient Alexandria
  + paid for by the crown
  + government would dictate what science would do
...
- liaised with Robert Boyle, Robert Hooke, Thomas Savery, Isaac Newton
...
- 1712 homeless
- Same year that Papin died, Royal Society gave award for inventor of pressure cooker
...
- cylinders would not precisely match pistons
...
- help from family
- introduction of factory system got rid of this
...
- almost anyone who invested in factory machinery at the time became a multi billionaire
*** No female engineers
- women not allowed to drive trains
**** Mary Fergusson
- first female civil engineer admitted to the institution of civil engineers in Britain
...
- Prince Albert trying to improve conditions for poor working class
  - designed neighbourhoods to keep workers off the streets
  - not very successful
  - however he made the world's first fair
  - no one could build a building large enough to accommodate such a large exhibition
*** Joseph Paxton
- gardener
...
- crystal palace
- from napkin drawing to large building in 9 months
...
- expected to be married, and you were basically a possession of your husband
...
- you pay monthly instalments and eventually own it
...
- collodian gun cotton + nitric acid + sulphuric acid
...
- cartridge
- came pre-loaded with a cartridge that lets you take 100 photos
...
- "Trevithick and others who are experimenting, as well as working, with steam of high pressure deserved hanging for their diabolical inventions"
...
- had headlights, better carburettor, electric spark, electrical ignition
- carburettor based on Heron of Alexandria's atomizer spray design
...
- questions that ask you to state and defend your opinion by providing relevant examples from the lectures
  ...
  2. Do you agree, or disagree that internal/internalistic approach is the best method for studying our relationship between science, technology and society? Based on the information provided in class support your argument with all necessary theories/arguments/details/dates/events/names etc.
     - Kuhn, Merton
  3. Was Robert Merton correct in postulating that religion had significant impact on scientific and technological change? Support your argument with examples from the lectures. Make sure to structure your essay chronologically, that is, start with the earliest examples and proceed to the newest.
...
**** Fokker
- Nazi Germany
- instead of firing guns into propeller
...
-
*** Katherine Stinson
- one of first female pilots to receive license from Wright brothers
...
- Germans applied factory system of mass murder and human disassembly
  ...
  + technoscience produced a lot of technologies we use today
...
- von Braun was an SS officer
  ...
  - swore oath of allegiance directly to Hitler
  - really nasty people
...
- new law:
  ...
  +
*** Sofia
- First robot to receive full citizenship
- we no longer really understand the difference between humans and machine
- American law system is now being rewritten to include artificial intelligence
...
- technology used for political/economic ends
...
- technoscience came from warfare
...
- technopoly ::
  ...
  2. ignorance - of what new technologies are doing to our lives/human relations
     + you don't think about what happens when you do a google search or tap your card
     + you're a sleeper
  ...
  6. ignorance of past/history
     ...
     - nowadays: conformity/ignorance
       ...
       - if you do not conform to modern society, you're considered to have a mental illness
...
- after that study, the importance of history went downhill 1957
